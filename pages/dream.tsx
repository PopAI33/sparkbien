  ...
  return (
    ...
    <><Head>
      ...
      <title>Sparkitect</title>
        ...
        <div className="flex max-w-9xl max-h-3xl bg-white mx-auto ml-4 mr-4 mt-4 flex-col rounded-3xl justify-center min-h-screen">
        <Header
        photo={session?.user?.image || undefined}
        email={session?.user?.email || undefined} />
          

          <main className="flex max-w-7xl flex-1 w-full flex-col items-center justify-center text-center mx-auto">
