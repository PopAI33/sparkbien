...
export default function Pricing() {
  ...
  return (
    <div className="flex mx-auto max-w-7xl overflow-visible bg-white rounded-3xl flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>Buy Sparkitect Credits</title>
      </Head>
      ...
      <p className="text-gray-400 mb-5">
        ...
        <span className="text-gray-300">contact@sparkitect.co</span>
      </p>
      <Footer />
    </div>
  );
